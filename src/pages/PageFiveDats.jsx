      ...
      modules: [
        {
          type: "Core",
          code: "C5-CE1-20",
          name: "Computer and its Essential 1",
          credit: 10,
          fee: "$130.00",
        },
        {
      ...
      modules: [
        {
          type: "Core",
          code: "C6-CE2-20",
          name: "Computer and its Essential 2",
          credit: 10,
          fee: "$130.00",
        },
        {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          type: "Core",
          code: "D6-ITR-21",
          name: "Introduction to Medical Transcription",
          credit: 10,
          fee: "$130.00",
        },
        {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          type: "Core",
          code: "D7-FTX-23",
          name: "Fundamentals of Toxicology",
          credit: 12,
          fee: "$156.00",
        },
        {
      ...
      modules: [
        {
          type: "Core",
          code: "D7-API-23",
          name: "Accident Prevention and Investigations",
          credit: 12,
          fee: "$156.00",
        },
        {
          type: "Core",
          code: "D7-PCC-23",
          name: "Principles of Climate Change",
          credit: 12,
          fee: "$156.00",
        },
        {
        ...
        },
        {
          type: "Core",
          code: "D7-OSM-23",
          name: "Occupational Safety Management",
          credit: 12,
          fee: "$156.00",
        },
      ],
    },
    {
      ...
      modules: [
        ...
        },
        {
          type: "Core",
          code: "D7-FAP-23",
          name: "First Aid Principles and Procedures",
          credit: 12,
          fee: "$156.00",
        },
        {
          type: "Core",
          code: "D7-PCO-23",
          name: "Principles of Counselling",
          credit: 10,
          fee: "$130.00",
        },
        {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          type: "Core",
          code: "D7-RP1-23",
          name: "Research Project 1 in OHS (Proposal writing)",
          credit: 12,
          fee: "$156.00",
        },
        {
          type: "Core",
          code: "D7-MOR-23",
          name: "Managing Occupational Records",
          credit: 12,
          fee: "$156.00",
        },
        {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          type: "Core",
          code: "D9-DI1-23",
          name: "Dissertation I (Year module)",
          credit: 24,
          fee: "$468.00",
        },
        {
      ...
      modules: [
        {
          type: "Core",
          code: "D9-DI2-23",
          name: "Dissertation II (Year Module)",
          credit: 56,
          fee: "$1,092.00",
        },
      ],
